...
The script:
a. fits ARIMA models for the Airlines data,
b. computes the forecasting errors,
c. produces RMSE, MAE, MAPE, and SMAPE.
...
a. MODWT decomposition using different filters and levels,
b. rolling-origin forecasting,
c. ARIMA modeling on decomposed series,
d. reconstruction of forecasts,
e. calculation of RMSE, MAE, MAPE, and SMAPE for each combination of dataset × filter × level.
